...
<form action="{{url('admin/seo/landing/update')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
           <input name="keyword" type="text" id="keyword" class="form-control" value="{{$seo->keywords}}"></input>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
           <input name="site_name" type="text" id="site_name" class="form-control" value="{{$seo->site_name}}"></input>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
           <input name="content_type" type="text" id="content_type" class="form-control" value="{{$seo->content_type}}"></input>
        </div>
    </div>
