...
@section('content')
<form action="{{url('admin/konten/update/about')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="card-header">
        <h3 class="card-title">Ubah konten About</h3>
   </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
...
<script>
   ClassicEditor
    ...
    CKEDITOR.plugins.add('#description', {
    init: function( editor ) {
      
        editor.addContentsCss('http://localhost:8000/assets/css/style.css' );
    }
} );
    </script>
@endsection